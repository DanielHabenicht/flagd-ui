...
//   private readonly flagBackend = inject(FLAG_BACKEND);
...
//   ): Promise<void> {
//     try {
//       const remoteFiles = await this.flagBackend.listCollections();
...
//           await this.flagBackend.deleteCollection(remoteFile.id);
//         }
//       }
...
//   ): Promise<void> {
//     try {
//       const collections = await this.flagBackend.listCollections();
//       const imported = await Promise.all(
//         collections.map(async (collection) => {
//           const content = await this.flagBackend.exportSchema(collection.id);
//           return {
